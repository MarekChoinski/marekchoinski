...
>
                ...
                <TwoColumnGrid
                    ...
                    key="designer"
                >
                    My main work on project was focused on designing every aspect of game. 3D models and UI graphic is my individual work. One of my tasks was to create consistent user-friendly UX experience. Models were created using Blender and GUI project along with concept arts was designed carefully in Photoshop. My role in the project was not only limited to the artistic side - developing frontend for game in Unity connected with backend in Django.
                </TwoColumnGrid>
